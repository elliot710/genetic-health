          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-10">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item.title} className="flex gap-4 p-5 rounded-2xl bg-slate-800/40 border border-slate-700/40">
            ...
            {/* Form */}
            <div className="rounded-3xl bg-slate-800/40 border border-slate-700/40 p-7 sm:p-10">
              {sent ? (
                <div className="h-full flex flex-col items-center justify-center text-center py-10">
                  ...
                  <p className="text-slate-400">Thanks for reaching out. We&apos;ll get back to you within one business day.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-600 text-white placeholder-slate-500 focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500/30 transition-colors text-sm"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-600 text-white focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500/30 transition-colors text-sm"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-600 text-white placeholder-slate-500 focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500/30 transition-colors text-sm resize-none"
                    />
                  </div>
