        ...
        <div className="grid grid-cols-2 md:grid-cols-[2fr_1fr_1fr_1fr] gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-4 group">
              ...
              <span className="text-lg font-bold text-white">Epigenic</span>
            </Link>
            ...
            <div className="flex items-center gap-3 mt-5">
              {SOCIAL.map(({ href, icon: Icon, label }) => (
                <a
                  ...
                  className="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-800 text-slate-400 hover:text-white hover:bg-slate-700 transition-colors"
                >
