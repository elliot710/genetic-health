...
const CATEGORIES: SidebarCategory[] = [
  ...
  { id: 'drug-responses', title: 'Drug Responses', icon: Shield },
  { id: 'physical-traits', title: 'Physical Traits', icon: Dna },
  ...
  { id: 'ancestry', title: 'Ancestry & Origins', icon: Users },
  { id: 'carrier-status', title: 'Carrier Status', icon: AlertTriangle },
  ...
  { id: 'detox', title: 'Detoxification', icon: Zap },
